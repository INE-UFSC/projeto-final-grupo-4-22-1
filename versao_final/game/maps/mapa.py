...
class Mapa:
    ...
    def spawn_consumiveis(self, colisoes, quant_apple, quant_mushroom):
    ...
    def spawn_all(self, colisoes, quant_apple, quant_mushroom, quant_flores):
        self.spawn_ra()
        self.spawn_consumiveis(colisoes, quant_apple, quant_mushroom)
        self.spawn_jacares()
        self.spawn_cobras()
