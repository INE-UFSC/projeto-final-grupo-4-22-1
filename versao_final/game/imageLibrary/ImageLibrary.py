...
class ImageLibrary():
    def __init__(self):
        ...
        self.__jacare_esquerda = os.path.join("game/imageLibrary/images/jacare_direita.png")
        self.__jacare_baixo = os.path.join("game/imageLibrary/images/jacare_baixo.png")
        self.__jacare_direita = os.path.join("game/imageLibrary/images/jacare_esquerda.png")
