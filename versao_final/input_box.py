...
class InputBox:
    ...
    def __init__(self, x, y, w, h, texto = ''):
        self.__fonte = pygame.font.Font(None, 32)
        self.__rect = pygame.Rect(x, y, w, h)
        self.__color = (0,0,0)
        self.__texto = texto
        self.__txt_surface = self.__fonte.render('', True, (233,233,233))
        self.__active = False
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            if self.__active:
                ...
                self.__txt_surface = self.__fonte.render(self.__texto, True, (233,233,233))
